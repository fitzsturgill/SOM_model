...
for i in arange(len(touch_strength)):    
    for j in arange(len(touch_angle)):
        ...
        ratePy_eq, rateSOM_eq, ratePV_eq = calc_equilibrium_x(rateIn, wInPy, wInSOM, wPySOM, wSOMPy, wInPV, wPyPV, wPVPy, wSOMPV, wPVSOM, 0)
