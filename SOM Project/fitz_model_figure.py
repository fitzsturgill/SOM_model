...
def calc_equilibrium(rateIn, bPy, bSOM, bPV, wInPy, wInSOM, wInPV, wPyPy, wPySOM, wPyPV, wSOMPy, wSOMSOM, wSOMPV, wPVPy, wPVSOM, wPVPV):
    """
...
for i in arange(len(stim_strength)):
    for j in arange(len(stim_rf)):
        ...
        ratePy_eq, rateSOM_eq, ratePV_eq = calc_equilibrium(rateIn, bPy, bSOM, bPV,
                            ...
                            wSOMPy, wSOMSOM, wSOMPV, wPVPy, wPVSOM, wPVPV)
